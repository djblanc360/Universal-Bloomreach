...
// const credentialsEdit = require('./credentials-EDIT.js')
// app.use('/exponea', credentialsEdit.exponea_authenticate, exponeaRoutes)
app.use('/exponea', exponeaRoutes)
app.use('/shopify', shopifyRoutes)

app.use(function (err, req, res) {
    req.body.email && console.log(req.body.email,'- in error handler: ',err)
